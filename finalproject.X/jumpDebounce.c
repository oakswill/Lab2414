...
static enum debounce_States { debounce_NOTJUMP, debounce_MAYBEJUMP, debounce_JUMP, debounce_INAIR, debounce_MAYBELAND, debounce_LAND } debounce_State;
...
void tickFct_debounce(uint8_t sensor)
{
